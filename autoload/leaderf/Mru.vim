...
function! leaderf#Mru#Maps()
    ...
    nnoremap <buffer> <silent> s             :exec g:Lf_py "mruExplManager.accept('h')"<CR>
    ...
    nnoremap <buffer> <silent> <Space>       :exec g:Lf_py "mruExplManager.addSelections()"<CR>
...
function! leaderf#Mru#NormalModeFilter(winid, key) abort
    ...
    elseif key ==# "<SPACE>"
        ...
        call leaderf#Mru#NormalModeFilter(a:winid, 'j')
    elseif key ==# "a"
